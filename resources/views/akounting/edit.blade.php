...
<div class="content-body">
 ...
 <form enctype="multipart/form-data" method="post" action="{{ route('account.update',$crud->id) }}">
    @csrf
    @method('patch')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">                                       
                                                ...
                                                <input type="text" id="eventRegInput1" class="form-control"
                                                    placeholder="name" name="name" value="{{$crud->name}}">
                                                @error('name')
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="eventRegInput2" class="form-control"
                                                    placeholder="tax" name="tax" value="{{$crud->tax}}">
                                                @error('tax')
                                                    <span class="text-danger">{{$message}}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="eventRegInput2" class="form-control"
                                                    placeholder="Sale Price" name="sale_price" value="{{$crud->sale_price}}">
                                                    @error('sale_price')
                                                    <span class="text-danger">{{$message}}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="eventRegInput2" class="form-control"
                                                    placeholder="Purchase Price" name="purchase_price" value="{{$crud->purchase_price}}">
                                         ...
                                         <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="eventRegInput2" class="form-control" name="category" value="{{$crud->category}}"
