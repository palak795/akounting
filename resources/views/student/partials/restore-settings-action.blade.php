<span class="dropdown">
    ...
    <span aria-labelledby="btnSearchDrop12" class="dropdown-menu mt-1 dropdown-menu-right" x-placement="bottom-end"
        ...
        <a href="#" data-form_id="{{ 'restore_form_' . $exist->id }}" class="delete dropdown-item"><i
                class="ft-trash-2"></i>Restore
        </a>
        <form action="{{ $restore }}" method="post" id="{{ 'restore_form_' . $exist->id }}">
            @csrf
