                        ...
                        <div class="card-header" style="height: 50px;">
                            <div class="card-title layout_btns" id="basic-layout-form">
                                ...
                                <div class="btns-right-side">
                                    <a href="{{ route('computers.index') }}" method="post"
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <form class="form" action="{{route('computers.multi-restore')}}" method="POST" id="{{'restore_all'}}">
                                        @csrf
        ...
        $(document).ready(function() {
            ...
            $('#details').DataTable({
                ...
                "ajax": {
                    ...
                    "data": {
                        _token: "{{ csrf_token() }}",
                        route: '{{ route('computers.restore_view') }}'
                    }
                },
                 "columns": [{
                        "data": "#"
